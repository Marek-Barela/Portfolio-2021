import { Menu, AboutContent, WorksContent, ContactContent } from './languageInterface';

import marketHub from '../assets/images/markethub.png';
...
export const worksContent: WorksContent = {
	projects: [
		{
			id: '1',
			projectTitle: 'MarketHub',
			projectDescription:
				'An application for checking the prices of rates and stock charts of various companies',
			link: '/works/markethub',
			content: [
				'An extensive application for checking stock prices from around the world. The application is based on the Alpha Vantage API',
				'Application was created with: React, Redux, Redux-Saga, Redux-persist, Reselect, Typescript, Apexchart',
			],
			image: marketHub,
			externalLinks: [
				{ title: 'Github', link: 'https://github.com/Marek-Barela/MarketHub' },
				{ title: 'MarketHub', link: 'https://markethub-pro.netlify.app/' },
			],
		},
		{
			id: '2',
		...
		},
		{
			...
			projectDescription: 'An application designed to store and organize your notes',
		...
		},
		{
			...
			projectDescription: 'Complex client side functionality of email application',
			link: '/works/mailbox',
			content: [
