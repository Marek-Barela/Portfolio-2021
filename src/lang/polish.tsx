	...
	projects: [
		{
			...
			projectDescription:
				'Aplikacja do sprawdzania kursów i wykresów giełdowych różnych firm',
			link: '/works/markethub',
			content: [
				'Rozbudowana aplikacja do sprawdzania kursów akcji z całego świata. Aplikacja oparta jest na Alpha Vantage API',
				'Wykorzystane technologie React, Redux, Redux-Saga, Redux-persist, Reselect, Typescript, Apexchart',
			],
			image: marketHub,
			externalLinks: [
		...
		},
		{
			...
			projectDescription: 'Przeliczanie i dane historyczne dla 33 różnych walut.',
